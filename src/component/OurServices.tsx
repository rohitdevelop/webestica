...
// Variants for the title entrance
const titleVariants = {
  hidden: { y: -30, opacity: 0 },
  visible: { y: 0, opacity: 1, transition: { duration: 0.8, ease: "easeOut" } },
};

// Variants for the image on hover
...
const OurServices = () => {
  ...
  // Note: We no longer need the 'isVisible' state/useEffect because we'll use whileInView or initial/animate on the container.
